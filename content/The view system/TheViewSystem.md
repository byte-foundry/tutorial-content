...
reward:
header: |
  There is three main views on the applications. How to work with them and use them correctly? Let's see.
---

In Prototypo, there is three main views:
* The **text** view
* The **word** view
* the **glyph** view

Each view have its purpose, and it's good to know how to manage and use them in order to feel comfortable while using the app.

## Display and resize the views
![ViewSystem - Switching view](viewsystem-switchingview.gif)

First off, **displaying** the views. On the top-right, there is three icons:  ![ViewSystem - View toogle](viewsystem-viewtoogle.jpg) that can be either green or white. Green means that the view is opened, and white that the view is hidden. You click on an icon to toogle the view display.
...
> There might be an issue where the resize bars are not there and you can't rezize the view.
...
Working on a full text can be all you need, but often you will need more. If you want to work on a logo or fine-tune your project, the word view is a good thing to work with. With the word view, you can display any text that you want in a bigger scale than the text-view and work on the details. 

To change the text displayed, click on the green bar below the Word view, and type the text that you want to be displayed.
![ViewSystem - Chande text](viewsystem-wordviewchangetext.gif)
...
(Learn more about spacing in [our spacing course](/academy/course/Spacing-In-Prototypo).
...
This view is mainly used to do some fine-tuning or corrections to a specific glyphs, or make hard modifications which goes whay below the range of the sliders.
...
* Click on the **glyph** button next to the **glyphs list** button which highlight it, then press the character that you want to be displayed on your keyboard.
