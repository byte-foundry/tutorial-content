---
title: Markdown Here
ogDescription: Sample markdown plaground
ogImage:
headerImage: https://raw.github.com/adam-p/markdown-here/master/src/common/images/icon48.png
...
reward:
header: |
  This is a sample markdown playground to test the layout across the app and the site
---
...
Writing email with code in it is pretty tedious. Writing Markdown with code in it is easy. I found myself writing email in Markdown in the Github in-browser editor, then copying the preview into email. This is [a pretty absurd workflow](/academy/course/The-Golden-Thread-and-Top-Bar) , so I decided create a tool to write and render Markdown right in the email.
